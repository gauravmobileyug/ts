      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">			<?php if(empty($user_data['profile_pic'])):?>
			<span class="glyphicon glyphicon-user custom-user-icon2"></span>			<?php else:?>
            <img src="<?php echo base_url($user_data['profile_pic']);?>" class="user-image" alt="User Image">			<?php endif;?>
              <span class="hidden-xs"><?php echo ucwords($user_data['firstname'].' '.$user_data['lastname']);?></span>
            </a>						<?php //fn_ems_debug( $user_data );?>			
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">				<?php if(empty($user_data['profile_pic'])):?>					<img src="<?php echo base_url('assets/images/blank_user.png');?>" class="img-circle" alt="User Image" data-toggle="modal"  style="cursor:pointer" data-target="#myModal">				<?php else:?>
					<img src="<?php echo base_url($user_data['profile_pic']);?>" class="img-circle" alt="User Image" data-toggle="modal"  style="cursor:pointer" data-target="#myModal">				<?php endif;?>
