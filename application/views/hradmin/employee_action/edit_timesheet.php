      ...
      <div class="row">
		...
		<div class="box box-solid">
			<div class="box-header with-border">
			 ...
			 <?php } elseif( (!empty($timesheets) && $timesheets[0]['submit'] == 1 && $valid_month) || $user_data['role']=='S') { ?>
				 <div class="pull-right">
					<button type="submit" name="submit" value="1" class="btn btn-primary save-submit"><i class="fa   fa-save"></i>  Save</button>
			 ...
			 <?php } elseif(!empty($timesheets) && $timesheets[0]['submit'] == 2 && $valid_month && $user_data['role']!='S') { 
					$readonly = 'readonly';$disabled = 'disabled'; 
			?>
				<div class="pull-right">
