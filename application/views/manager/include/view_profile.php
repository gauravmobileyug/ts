<?php 	$user_photo = 'assets/images/blank_user.png';	$documents = array() ;	if( !empty($employee_details['documents'])){		$documents = unserialize( $employee_details['documents'] );				if( isset($documents) && array_key_exists('user_photo',$documents) ){			$user_photo = $documents['user_photo'];		}				unset($documents['user_photo']);		unset($documents['user_other']);			}?><div class="content-wrapper"><section class="content-header">  <h1>	Employee Profile  </h1>  <ol class="breadcrumb">	<li><a href="<?php echo site_url();?>"><i class="fa fa-dashboard"></i> Home</a></li>	<li class="active">Employee Profile</li>  </ol></section><!-- Main content --><section class="content"><div class="row"><div class="col-md-3">  <div class="box box-primary">	<div class="box-body box-profile">	  <img class="profile-user-img img-responsive" src="<?php echo base_url($user_photo);?>" alt="User profile picture">	  <h3 class="profile-username text-center"><?php echo isset($employee_details) ? ucwords($employee_details['firstname'] .' '. $employee_details['lastname'])  : '' ;?></h3>	  <p class="text-muted text-center"><?php echo ucwords($employee_details['user_designation_description']);?></p>	  <ul class="list-group list-group-unbordered">		<li class="list-group-item">		  <i class="fa fa-birthday-cake"></i> <b> Birthday </b> 		  			<?php 			$dob_this_year = '';			$class = '';			if( isset($employee_details) ) {				$dob = date('d M',strtotime($employee_details['dob']));				$dob_this_year = $dob. ' '. date('Y');								if($dob == date('d M')){					$class = 'birth_day';				}											}?>		  		  <a class="pull-right <?php echo $class;?>">			<?php echo $dob_this_year ;?>		  </a>		  		 		</li>		<li class="list-group-item">		  <i class="fa fa-thumbs-o-up"></i> <b> Anniversary </b> <a class="pull-right"><?php echo date('d M Y' ,strtotime($employee_details['doj']));?></a>		</li>		<!-- <li class="list-group-item">		  <i class="fa fa-tasks"></i> <b> Applied Leaves </b> <a class="pull-right">22</a>		</li>				-->					  </ul>	</div>	<!-- /.box-body -->  </div></div><div class="col-xs-9">
<div class="box">
	<div class="box-body">	
