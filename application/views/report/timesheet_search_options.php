<form method="GET" action="<?php echo site_url('report/timesheet_reports');?>">
	<table class="table">
		<tbody>
			...
			<tr>
			  ...
			  <td><input type="text" class="form-control" name="search[ticket_number]" id="ticket_number"  value="<?php echo isset($search_params['ticket_number']) ? $search_params['ticket_number']:''?>" placeholder="Ticket Number" autocomplete="off"/></td>
